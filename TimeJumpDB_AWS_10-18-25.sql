...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2025-10-14 22:27:06',NULL),('diagnostics.include_raw','OFF','2025-10-14 22:27:06',NULL),('ps_thread_trx_info.max_length','65535','2025-10-14 22:27:06',NULL),('statement_performance_analyzer.limit','100','2025-10-14 22:27:06',NULL),('statement_performance_analyzer.view',NULL,'2025-10-14 22:27:06',NULL),('statement_truncate_len','64','2025-10-14 22:27:06',NULL);
...
-- Dump completed on 2025-10-18 10:36:20
...
CREATE TABLE `schedules` (
  ...
  CONSTRAINT `chk_sched_time_window` CHECK (((`Start_time` between _utf8mb3'12:00:00' and _utf8mb3'23:59:59') and (`End_time` between _utf8mb3'12:00:00' and _utf8mb3'23:59:59')))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-10-18 10:36:31
